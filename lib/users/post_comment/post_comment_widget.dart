...
class PostCommentWidget extends StatefulWidget {
  ...
  static String routeName = 'PostComment';
  static String routePath = '/postComment';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PostsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final postCommentPostsRecord = snapshot.data!;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            body: StreamBuilder<UserRecord>(
              stream: UserRecord.getDocument(postCommentPostsRecord.postedBy!),
              builder: (context, snapshot) {
                // Customize what your widget looks like when it's loading.
                if (!snapshot.hasData) {
                  return Center(
                      ...
                      Column(
                        ...
                        children: [
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          formatNumber(
                                            containerUserRecord.rankInWeek,
                          ...
                          wrapWithModel(
                            ...
                            child: PostWidget(
                              photos: postCommentPostsRecord.additionalPhotos,
                              postTitle: postCommentPostsRecord.postTitle,
                              userName: containerUserRecord.displayName,
                              userImage: containerUserRecord.photoUrl,
                              likes: formatNumber(
                                postCommentPostsRecord.likes,
                                formatType: FormatType.compact,
                              ),
                              comments: formatNumber(
                                postCommentPostsRecord.comments,
                                formatType: FormatType.compact,
                              ),
                              stars: formatNumber(
                                postCommentPostsRecord.vote,
                                formatType: FormatType.compact,
                              ),
                              postDocRef: postCommentPostsRecord.reference,
                              goToComments: () async {},
                            ),
                          ),
                          Align(
                          ...
                          StreamBuilder<List<CommentsRecord>>(
                            stream: queryCommentsRecord(
                              queryBuilder: (commentsRecord) => commentsRecord
                                  .where(
                                    'Post_ref',
                                    isEqualTo: postCommentPostsRecord.reference,
                                  )
                                  .orderBy('DatreCreated', descending: true),
                              limit: 100,
                            ),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                                ...
                                onTap: () async {
                                  await CommentsRecord.collection
                                      ...
                                      .set(createCommentsRecordData(
                                        ...
                                        postRef:
                                            postCommentPostsRecord.reference,
